        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {roleInfo && (
            <button
              ...
              className={`hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium text-white cursor-pointer hover:opacity-80 hover:shadow-md transition-all group ${roleInfo.color}`}
              title="クリックでコースを変更"
            >
