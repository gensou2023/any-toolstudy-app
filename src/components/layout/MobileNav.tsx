...
export default function MobileNav({ role = null }: MobileNavProps) {
  ...
  const tabs = [
    ...
    {
      href: isIntern ? '/intern/badges' : '/badges',
      label: 'バッジ',
      matchPrefix: isIntern ? '/intern/badges' : '/badges',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            strokeLinecap="round"
    ...
    {
      href: isIntern ? '/intern/ranking' : '/ranking',
      label: 'ランキング',
      matchPrefix: isIntern ? '/intern/ranking' : '/ranking',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            strokeLinecap="round"
